...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        dele = []
        for co in opponent.deck.cards:
            if co.attack == other_card.attack or co.defense == other_card.defense:
                dele += [co]
        opponent.deck.cards = [item for item in opponent.deck.cards if item not in dele]
        # print(len(opponent.deck.cards))
