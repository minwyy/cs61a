...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            if isinstance(insect, QueenAnt) and insect.only_one:
                return None
            # END Problem 13
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        if self.max_range:
            while not bees and place != hive and count <= self.max_range:
                bees = place.bees
                place = place.entrance
                count += 1
        else:
        ...
        if self.armor <= 0:
            if self.place.bees:
                ...
                for _ in a[:]:
                    ...
                    l = len(self.place.bees)
                    self.place.bees[n].reduce_armor(self.damage)
                    if l == len(self.place.bees):
                        n += 1
            self.place.remove_insect(self)
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        self.only_one = QueenAnt.only_one
        QueenAnt.only_one = False
        # END Problem 13
            ...
            while place.exit != None:
                if place.ant:     
                    if place.ant.is_container:
                        if place.ant.contained_ant and not place.ant.contained_ant.is_buffed:
                            place.ant.contained_ant.damage *= 2
                            place.ant.contained_ant.is_buffed = True
                        elif place.ant.damage and not place.ant.is_buffed:
                            place.ant.damage *= 2
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self, hive):
        ...
        while place != hive:
            if place.bees:
                # print(self.place.bees)
                for a in place.bees:
                    damage_list[a] = distance
            if place.ant:
                damage_list[place.ant] = distance
            place = place.entrance
            distance += 1      
        if self.place.ant == self:
            del damage_list[self]
        # print(damage_list)
        return damage_list
        # END Problem OPTIONAL
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem OPTIONAL
        final_damage =  2 - 0.2 * distance - 0.05 * self.insects_shot
        # print(final_damage, distance, self.insects_shot)
        if final_damage > 0:
            return final_damage
        else:
            return 0
