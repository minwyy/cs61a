...
(define (longest-increasing-subsequence lst)
 ;    (define bigger?
	...
	; (define (helper lst)
	; (if (null? lst) nil 
	; 				(define withfirst (append (list (car lst)) (helper (filter bigger? (cdr lst)))))
	; 				 (define withoutfirst (helper (cdr lst)))
	; 				 (if (>= (length withfirst) (length withoutfirst)) withfirst withoutfirst)
